...
The set was refreshed in the fifteenth session from the `Capture store
...
not captured. Two frames changed for the reader: the chrome carries the
smaller top bar, and the search filters show their checks. Every frame was
